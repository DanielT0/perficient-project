...
router.route("/").post(authController_1.signup).get(authController_1.protect, userController_1.getAllUsers);
router
    .route("/:id")
    .patch(authController_1.protect, userController_1.updateUserPartially)
    .get(authController_1.protect, userController_1.getUser)
    .delete(authController_1.protect, userController_1.deleteUser);
router.put("/:id", [
